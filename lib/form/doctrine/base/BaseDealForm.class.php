...
abstract class BaseDealForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'seller_id'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Seller'), 'add_empty' => false)),
      'store_id'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Store'), 'add_empty' => false)),
      'quarter_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Quarter'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'seller_id'        => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Seller'))),
      'store_id'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Store'))),
      'quarter_id'       => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Quarter'))),
      ...
      'published_value'  => new sfValidatorInteger(),
      'real_value'       => new sfValidatorInteger(),
      'image'            => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'title'            => new sfValidatorString(array('max_length' => 255)),
      'newsletter_title' => new sfValidatorString(array('max_length' => 50)),
