...
abstract class BasePaymentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dm_buyer_email'   => new sfWidgetFormFilterInput(),
      'dm_buyer_address' => new sfWidgetFormFilterInput(),
      'dm_buyer_comment' => new sfWidgetFormFilterInput(),
      'dm_buyer_name'    => new sfWidgetFormFilterInput(),
      'dm_buyer_phone'   => new sfWidgetFormFilterInput(),
      'dm_buyer_tipodoc' => new sfWidgetFormFilterInput(),
      'dm_buyer_numdoc'  => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'dm_buyer_email'   => new sfValidatorPass(array('required' => false)),
      'dm_buyer_address' => new sfValidatorPass(array('required' => false)),
      'dm_buyer_comment' => new sfValidatorPass(array('required' => false)),
      'dm_buyer_name'    => new sfValidatorPass(array('required' => false)),
      'dm_buyer_phone'   => new sfValidatorPass(array('required' => false)),
      'dm_buyer_tipodoc' => new sfValidatorPass(array('required' => false)),
      'dm_buyer_numdoc'  => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'dm_buyer_email'   => 'Text',
      'dm_buyer_address' => 'Text',
      'dm_buyer_comment' => 'Text',
      'dm_buyer_name'    => 'Text',
      'dm_buyer_phone'   => 'Text',
      'dm_buyer_tipodoc' => 'Text',
      'dm_buyer_numdoc'  => 'Text',
      'created_at'       => 'Date',
      'updated_at'       => 'Date',
    );
  }
