...
<tr>
    ...
    <a href="<?=$base_url.'/oferta/'.$deal['id']?>" style="text-decoration:none;color:#333;">
  		<?=$deal->getTitle()?>
    </a>
	</td>
</tr>
					  ...
					  <td bgcolor="#93aa28" width="218" height="70">
						  <table width="218">
						    <tr style="text-align: center;">
							    <td>
								    <a href="<?=$base_url.'/oferta/'.$deal['id']?>" style="font-weight:bold;font-size:32px;color: #fff;text-decoration:none">
									    $<?=$deal->getValue()?>
								    </a>
							    </td>
							    <td>
								    <a href="<?=$base_url.'/oferta/'.$deal['id']?>" style="padding:12px 8px;font-size:14px;color: #444;background:#fecd07;border:3px solid #fff;border-radius:15px;text-decoration:none">
									    VER MÁS
								    </a>
							    </td>
						    </tr>
